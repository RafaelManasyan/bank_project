...
''')
    ...
    while True:
        ...
        trans_state = input('''Введите статус, по которому необходимо выполнить фильтрацию.
...
''').upper()
    ...
    for trans in word_filtered_trans:
        ...
        print(f'''
{new_trans_date_obj} {trans['description']}
{trans['from']} {trans['to']}
Сумма: {trans['amount']} {trans['currency_code'] or trans["operationAmount"]["currency"]["code"]}''')
